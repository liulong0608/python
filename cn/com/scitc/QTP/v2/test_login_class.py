...
class TestLogin(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.driver.get("http://192.168.31.245/ciircrm")
    ...
    def test_login_username_not_exist(self):
        driver = self.driver
        username=driver.find_element(By.NAME, "name")  # 输入用户名
        username.clear()
        username.send_keys("admins")
        pwd=driver.find_element(By.NAME, "password")  # 输入密码
        pwd.clear()
        pwd.send_keys("admin")
